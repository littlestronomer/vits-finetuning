            ...
            for (net_g_ms, tts_fn) in models:
                with gr.TabItem(args.model):
                    with gr.Row():
                        ...
                        download.click(fn=None, inputs=[], outputs=[], js=download_audio_js)
    if args.colab:
        webbrowser.open("http://127.0.0.1:7860")
    app.queue(default_concurrency_limit=1, api_open=args.api).launch(share=args.share, max_threads=1)
